...
{
  pqcrystals_kyber768_ref_keypair_derand(pk, sk, randomness);
                            ...
                            const unsigned char *coins)
{
  ...
  pqcrystals_kyber768_ref_enc_derand(ct, bufferPointer, pk, coins);
                     ...
                     const uint8_t *sk)
{
  ...
  pqcrystals_kyber768_ref_dec(bufferPointer, ct, sk);
