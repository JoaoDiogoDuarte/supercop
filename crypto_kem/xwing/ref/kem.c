...
#include <stdlib.h>
#include <lib25519.h>
// #include <libpqcrystals_mlkem768_ref.h>
...
{
  pqcrystals_mlkem768_ref_keypair_derand(pk, sk, randomness);
                            ...
                            const unsigned char *coins)
{
  ...
  pqcrystals_mlkem768_ref_enc_derand(ct, bufferPointer, pk, coins);
                     ...
                     const uint8_t *sk)
{
  ...
  pqcrystals_mlkem768_ref_dec(bufferPointer, ct, sk);
